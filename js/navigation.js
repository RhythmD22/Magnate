(function () {
  ...
  function generateSidebarHTML() {
    return '' +
      ...
      '</div>' +
      '<div class="nav-item">' +
      '<a href="Goals%20%26%20Categories.html" class="nav-link">' +
      '<svg viewBox="0 0 24 24" width="24" height="24" preserveAspectRatio="xMidYMid meet" aria-hidden="true">' +
      ...
      '</div>' +
      '<div class="nav-item">' +
      '<a href="Track%20Transactions.html" class="nav-link">' +
      ...
      '<svg viewBox="0 0 24 24" aria-hidden="true">' +
      '<rect x="4" y="2" width="16" height="20" rx="2" fill="none" stroke="#508de6" stroke-width="1"/>' +
      '<rect x="6" y="4" width="12" height="3" rx="0.5" fill="#508de6" stroke="#508de6" stroke-width="1"/>' +
      ...
      '<rect x="15" y="13" width="2" height="6" rx="0.5" fill="#508de6" stroke="#508de6" stroke-width="1"/>' +
      ...
      '</div>' +
      '<div class="nav-item">' +
      '<a href="Money%20Tips.html" class="nav-link">' +
      '<svg viewBox="0 0 24 24" aria-hidden="true">' +
      ...
      '</div>' +
      '<div class="swipe-indicator swipe-open">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' +
